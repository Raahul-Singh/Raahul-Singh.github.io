...
\begin{tightemize}
        ...
        \item Engineered the agent's tool-execution layer to perform \textbf{automated information fusion and synthesis}, aggregating heterogeneous industrial data sources for complex multi-step reasoning.
        \item {Designed and implemented an end to end interactive platform for monitoring and analysing all production models and agents for performance and biases, giving insights to Domain Experts for reliable support.}
        ...
        \item {Engineered solutions for large-scale decision problems with complex action spaces, optimising computational efficiency and decision quality.}    
...
\begin{tightemize}
    \item \textbf{Raahul Singh}, Ashutosh Pandey. (2025). \textit{Starkindler: An Uncertainty Aware Objective for Photometric Redshift Estimation.} arXiv preprint arXiv:24xx.xxxxx.
    ...
    \item \href{https://arxiv.org/abs/xxxx.xxxxx}{[\textbf{Link to Paper}]} \ \ \href{https://github.com/Raahul-Singh/starkindler}{[\textbf{Source Code}]}
\end{tightemize}
\sectionsep
